...
public class JFSanPham extends JFrame {
    ...
    private void initComponents() {
        ...
        pnlMain.setBackground(util.TechStoreUI.BG_MAIN);
        ...
        pnlTableContainer.setBackground(util.TechStoreUI.CARD_BG);
        pnlTableContainer.setBorder(new EmptyBorder(20, 20, 20, 20));

        JPanel pnlTopBar = new JPanel(new BorderLayout());
        pnlTopBar.setBackground(util.TechStoreUI.CARD_BG);
        ...
        scrollTable.setBorder(BorderFactory.createLineBorder(util.TechStoreUI.BORDER));
        ...
        pnlFooter.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createMatteBorder(1, 0, 0, 0, util.TechStoreUI.BG_MAIN),
        ...
        pnlFormHeader.setBackground(util.TechStoreUI.CARD_BG);
        pnlFormHeader.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createMatteBorder(0, 0, 1, 0, util.TechStoreUI.BG_MAIN),
        ...
        pnlPriceQty.setBackground(util.TechStoreUI.CARD_BG);
        ...
        pnlActions.setBackground(util.TechStoreUI.CARD_BG);
        ...
        pnlImageContainer.setBackground(util.TechStoreUI.BG_MAIN);
        ...
        pnlImageWrapper.setBackground(util.TechStoreUI.CARD_BG);
        ...
        pnlRightTop.setBackground(util.TechStoreUI.CARD_BG);
