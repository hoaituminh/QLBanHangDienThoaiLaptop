...
public class JFLapHoaDon extends JFrame {
    ...
    private final Color bgMain = util.TechStoreUI.BG_MAIN;
    ...
    private JPanel buildProductCard() {
        ...
        pnlQuickAdd.setBackground(util.TechStoreUI.BG_MAIN);
        ...
        scrollTable.setBorder(BorderFactory.createLineBorder(util.TechStoreUI.BG_MAIN));
        ...
        pnlEmptyCart.setBackground(util.TechStoreUI.CARD_BG);
    ...
    private JPanel createPreviewRow(String label, JLabel value) {
        ...
        row.setBackground(util.TechStoreUI.BG_MAIN);
    ...
    private JComboBox<KhachHang> createKhachHangCombo() {
        ...
        cbo.setBackground(util.TechStoreUI.CARD_BG);
