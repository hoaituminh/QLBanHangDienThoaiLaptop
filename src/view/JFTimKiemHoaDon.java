...
public class JFTimKiemHoaDon extends JDialog {
    ...
    private void initComponents() {
        ...
        pnlMainContainer.setBackground(new Color(241, 245, 249));
        ...
        card.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(new Color(226, 232, 240), 1), // Viền Slate 200 mờ
        ...
        pnlSearch.setBackground(new Color(248, 250, 252));
        ...
        cboNhanVien.setBackground(new Color(248, 250, 252));
        cboNhanVien.setBorder(BorderFactory.createLineBorder(new Color(226, 232, 240), 1));
        ...
        tblHoaDon.setGridColor(new Color(241, 245, 249)); // Viền ngang mờ
        
        tblHoaDon.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 13));
        tblHoaDon.getTableHeader().setBackground(new Color(248, 250, 252)); // Nền header xám mịn
        ...
        pnlFoot.setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, new Color(241, 245, 249)));
